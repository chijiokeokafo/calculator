...
def create
   ...
   respond_to do |format|
     if @classified.save
       ...
       format.html { redirect_to @classified, notice: 'Picture was successfully created.' }
     else
 ...
 private
   def classified_params
      params.require(:classified).permit(:title, post_attachments_attributes: [:id, :post_id, :avatar])
   end
